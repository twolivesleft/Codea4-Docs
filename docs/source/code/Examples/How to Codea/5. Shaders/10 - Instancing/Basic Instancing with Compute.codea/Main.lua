...
function setup()
    ...
    m:addElement(4,3,1)
    m.shader = instancing
    instancing.s_texture = image.read(asset.builtin.Cargo_Bot.Codea_Icon)
    ...
    instancing:setBuffer("instancesBuffer", instancesBuffer, shader.readonly)
